...
class CalculatorHead extends Component {
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="calculator_head">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
CalculatorHead.propTypes = propTypes;

CalculatorHead.defaultProps = defaultProps;

CalculatorHead = WithUi(uiProps)(CalculatorHead);
