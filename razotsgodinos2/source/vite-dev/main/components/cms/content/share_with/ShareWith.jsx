...
class ShareWith extends Component {
	...
	renderLangTab = lang => {
		...
		const share_project = get(_langData, 'share_project', '');

		return (
			<Fragment>
				<Field
					label="Apraksts"
					name={`${lang}_share_project`}
					component={Input}
					value={share_project}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="share_with">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
ShareWith.propTypes = propTypes;

ShareWith.defaultProps = defaultProps;

ShareWith = WithUi(uiProps)(ShareWith);
