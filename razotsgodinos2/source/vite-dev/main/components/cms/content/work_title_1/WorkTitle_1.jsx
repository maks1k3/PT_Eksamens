...
class WorkTitle_1 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const work_title1 = get(_langData, 'work_title1', '');

		return (
			<Fragment>
				<Field
					label="Virsraksts"
					name={`${lang}_work_title1`}
					component={Input}
					value={work_title1}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="work_title_1">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
WorkTitle_1.propTypes = propTypes;

WorkTitle_1.defaultProps = defaultProps;

WorkTitle_1 = WithUi(uiProps)(WorkTitle_1);
