...
class WorkTitle_2 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const work_title2 = get(_langData, 'work_title2', '');

		return (
			<Fragment>
				<Field
					label="Virsraksts"
					name={`${lang}_work_title2`}
					component={Input}
					value={work_title2}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="work_title_2">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
WorkTitle_2.propTypes = propTypes;

WorkTitle_2.defaultProps = defaultProps;

WorkTitle_2 = WithUi(uiProps)(WorkTitle_2);

export default WorkTitle_2;
