...
class TipOpenBtn1 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const tip_open_Btn1 = get(_langData, 'tip_open_Btn1', '');

		return (
			<Fragment>
				<Field
					label="Pogas nosaukums"
					name={`${lang}_tip_open_Btn1`}
					component={Input}
					value={tip_open_Btn1}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="tip_open_btn1">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
TipOpenBtn1.propTypes = propTypes;

TipOpenBtn1.defaultProps = defaultProps;

TipOpenBtn1 = WithUi(uiProps)(TipOpenBtn1);
