...
class CalculatorImage_2 extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="calculator_image_2">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
CalculatorImage_2.propTypes = propTypes;

CalculatorImage_2.defaultProps = defaultProps;

CalculatorImage_2 = WithUi(uiProps)(CalculatorImage_2);

export default CalculatorImage_2;
