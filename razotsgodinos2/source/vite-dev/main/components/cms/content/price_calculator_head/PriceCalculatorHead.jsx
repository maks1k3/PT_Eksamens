...
class PriceCalculatorHead extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="price_calculator_head">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
PriceCalculatorHead.propTypes = propTypes;

PriceCalculatorHead.defaultProps = defaultProps;

PriceCalculatorHead = WithUi(uiProps)(PriceCalculatorHead);
