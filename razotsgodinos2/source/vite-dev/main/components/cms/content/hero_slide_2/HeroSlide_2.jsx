...
class HeroSlide_2 extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="hero_slide_2">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
HeroSlide_2.propTypes = propTypes;

HeroSlide_2.defaultProps = defaultProps;

HeroSlide_2 = WithUi(uiProps)(HeroSlide_2);

export default HeroSlide_2;
