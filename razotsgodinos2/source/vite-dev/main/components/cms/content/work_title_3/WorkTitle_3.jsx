...
class WorkTitle_3 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const work_title3 = get(_langData, 'work_title3', '');

		return (
			<Fragment>
				<Field
					label="Virsraksts"
					name={`${lang}_work_title3`}
					component={Input}
					value={work_title3}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="work_title_3">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
WorkTitle_3.propTypes = propTypes;

WorkTitle_3.defaultProps = defaultProps;

WorkTitle_3 = WithUi(uiProps)(WorkTitle_3);

export default WorkTitle_3;
