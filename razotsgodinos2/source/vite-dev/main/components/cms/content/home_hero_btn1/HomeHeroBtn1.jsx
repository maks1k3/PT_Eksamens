...
class HomeHeroBtn1 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const home_hero_Btn1 = get(_langData, 'home_hero_Btn1', '');

		return (
			<Fragment>
				<Field
					label="Pogas nosaukums"
					name={`${lang}_home_hero_Btn1`}
					component={Input}
					value={home_hero_Btn1}
				/>
			</Fragment>
		);
		//</editor-fold>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="home_hero_btn1">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
HomeHeroBtn1.propTypes = propTypes;

HomeHeroBtn1.defaultProps = defaultProps;

HomeHeroBtn1 = WithUi(uiProps)(HomeHeroBtn1);
