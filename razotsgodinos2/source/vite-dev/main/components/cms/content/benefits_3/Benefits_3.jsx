...
class Benefits_3 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const benefit_3 = get(_langData, 'benefit_3', '');

		return (
			<Fragment>
				<Field
					label="Apraksts Nr3"
					name={`${lang}_benefit_3`}
					component={Input}
					value={benefit_3}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="benefits_3">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
Benefits_3.propTypes = propTypes;

Benefits_3.defaultProps = defaultProps;

Benefits_3 = WithUi(uiProps)(Benefits_3);
