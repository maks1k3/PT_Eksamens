...
class Tipveida extends Component {
	constructor(props) {
		super(props);
	}
...
Tipveida.propTypes = propTypes;

Tipveida.defaultProps = defaultProps;

Tipveida = WithUi(uiProps)(Tipveida);

export default Tipveida;
