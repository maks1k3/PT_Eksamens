...
class CalculatorImage_1 extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="calculator_image_1">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
CalculatorImage_1.propTypes = propTypes;

CalculatorImage_1.defaultProps = defaultProps;

CalculatorImage_1 = WithUi(uiProps)(CalculatorImage_1);

export default CalculatorImage_1;
