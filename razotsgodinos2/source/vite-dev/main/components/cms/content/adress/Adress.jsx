...
class Adress extends Component {
	...
	renderLangTab = (lang) => {
		...
		const adress = get(_langData, 'adress', '');
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="adress">{this.renderForm()}</EditContentForm>
			</Fragment>
		);
	}
}

Adress.propTypes = propTypes;

Adress.defaultProps = defaultProps;

Adress = WithUi(uiProps)(Adress);
