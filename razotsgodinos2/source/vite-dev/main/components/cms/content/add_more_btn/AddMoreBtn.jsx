...
class AddMoreBtn extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = lang => {
		...
		const add_more = get(_langData, 'add_more', '');
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="add_more_btn">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
AddMoreBtn.propTypes = propTypes;

AddMoreBtn.defaultProps = defaultProps;

AddMoreBtn = WithUi(uiProps)(AddMoreBtn);
