...
class HeroSlide_1 extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="hero_slide_1">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
HeroSlide_1.propTypes = propTypes;

HeroSlide_1.defaultProps = defaultProps;

HeroSlide_1 = WithUi(uiProps)(HeroSlide_1);

export default HeroSlide_1;
