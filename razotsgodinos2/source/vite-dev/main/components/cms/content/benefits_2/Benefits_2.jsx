...
class Benefits_2 extends Component {
	constructor(props) {
		super(props);
	}
	...
	renderLangTab = (lang) => {
		...
		const benefit_2 = get(_langData, 'benefit_2', '');

		return (
			<Fragment>
				<Field
					label="Apraksts Nr2"
					name={`${lang}_benefit_2`}
					component={Input}
					value={benefit_2}
				/>
			</Fragment>
	...
	render() {
		return (
			<Fragment>
				<EditContentForm name="benefits_2">{this.renderForm()}</EditContentForm>
			</Fragment>
		);
	}
}

Benefits_2.propTypes = propTypes;

Benefits_2.defaultProps = defaultProps;

Benefits_2 = WithUi(uiProps)(Benefits_2);

export default Benefits_2;
