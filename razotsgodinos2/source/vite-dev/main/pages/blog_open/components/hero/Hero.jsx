...
class Hero extends Component {
	render() {
		...
		const projectsLabel = isTip ? 'Tipveida projekti' : 'Mūsu projekti';
		const projectsHref = isTip
			? getMainUrl(true) + 'tipveida-projekti'
			: getMainUrl(true) + 'projekti';
		...
		return (
			<div className={styles.wrapper}>
				...
				<div className={styles.blog_info}>
					<div className={styles.blog_info_left}>
						{isTip ? <TipContent blog={blog} /> : <Content blog={blog} />}
					</div>

					<div className={styles.blog_info_right}>
						{blog?.image?.image && (
							<Image
				...
				<div className={styles.navigation}>
					...
					<a className={styles.category} href={projectsHref}>
						{projectsLabel}
					</a>
